...
function ez.registerContext(context)
...
---@return string?
function ez.getOpenContextMenu() return openContextMenu end

---@param onExit boolean?
function ez.hideContext(onExit) closeContext(nil, nil, onExit) end
